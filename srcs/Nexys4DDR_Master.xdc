...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { swt_i }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { inc_bn_i }]; #IO_L9P_T1_DQS_14 Sch=btnc center
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { mode_bn_i }]; #IO_L4N_T0_D05_14 Sch=btnu up
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { shft_bn_i }]; #IO_L12P_T1_MRCC_14 Sch=btnl left
